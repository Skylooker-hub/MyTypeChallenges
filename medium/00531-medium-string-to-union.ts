...
// type StringToTuple<S extends string, T extends string[] = []> = S extends `${infer F}${infer Rest}`
//   ? StringToTuple<Rest, [...T, F]>
//   : T;

// type TupleToUnion<T extends string[]> = T[number];

// type StringToUnion<S extends string> = S extends "" ? never : TupleToUnion<StringToTuple<S>>;
