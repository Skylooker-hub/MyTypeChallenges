...
> = S extends `${infer F}${infer Rest}`
  ? F extends "+" | "-"
    ? PercentageParser<Rest, [`${Result[0]}${F}`, `${Result[1]}`, `${Result[2]}`]>
    : F extends "%"
    ? PercentageParser<Rest, [`${Result[0]}`, `${Result[1]}`, `${Result[2]}${F}`]>
    : PercentageParser<Rest, [`${Result[0]}`, `${Result[1]}${F}`, `${Result[2]}`]>
  : Result;
